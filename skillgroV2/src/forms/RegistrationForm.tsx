...
const RegistrationForm = () => {
    ...
    useEffect(() => {
        ...
        script.src = "https://www.google.com/recaptcha/api.js?render=6LdgsugqAAAAAHMldg7U4epeRSCF5xKFvOc14jwu"; // Remplace par ton Site Key
        script.async = true;
        script.onload = () => {
            ...
            window.grecaptcha.ready(() => {
                ...
                window.grecaptcha
                    .execute("6LdgsugqAAAAAHMldg7U4epeRSCF5xKFvOc14jwu", { action: "register" })
                    .then((token: string) => {
