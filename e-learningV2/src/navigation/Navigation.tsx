...
import InstructorAnalyse from '../pages/InstructorAnalyse.tsx';

const AppNavigation = () => {
  //const user = { name: "ghazi", email: "ghazysaoudi007@gmail.com" }; // Replace with actual user data
  return (
      <Router basename="/">
      <Routes>
        ...
        <Route path="/instructor-analyse" element={<InstructorAnalyse/>} />
