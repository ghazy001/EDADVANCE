            ...
            <div className="row justify-content-between align-items-start">
               <div className="col-xl-5 col-lg-6">
                  <div className="banner__content-three">
                     ...
                     <h2 className="title" data-aos="fade-right" data-aos-delay="400"> Higher School of Engineering and Technology <span>Futures</span></h2>
               ...
               <div className="col-lg-6">
                  <div className="banner__images-three">
                     ...
                     <div className="about__enrolled" data-aos="fade-right" data-aos-delay="900" >
                        <p className="title"><span>11K+</span> Enrolled Students</p>
