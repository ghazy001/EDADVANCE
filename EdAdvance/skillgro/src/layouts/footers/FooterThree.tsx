      ...
      <footer className="footer__area-four footer__bg" style={{ backgroundImage: `url(/assets/img/bg/h5_footer.jpg)` }}>
         ...
         <div className="footer__shape-wrap">
            ...
            <div className="shape-inner">
               <svg xmlns="http://www.w3.org/2000/svg" width="149" height="297" viewBox="0 0 149 297" fill="none" data-inject-url="http://127.0.0.1:5500/EdAdvance-html/assets/img/others/h5_footer_shape05.svg" className="injectable">
